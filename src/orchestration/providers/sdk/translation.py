"""Translate SDK message types to orchestration Message objects."""
...
def translate_sdk_message(sdk_msg: Any, sender: str) -> list[Message]:
    """Convert an SDK message into zero or more orchestration Messages.

    An ``AssistantMessage`` may contain multiple content blocks, each of
    which becomes its own orchestration ``Message``.  Other SDK types
