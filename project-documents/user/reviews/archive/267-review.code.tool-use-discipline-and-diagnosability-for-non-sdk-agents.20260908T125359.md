...
findings:
  - id: F001
    ...
    summary: "Degraded terminal message assumes a saved markdown artifact"
    location: "src/squadron/cli/commands/review.py:170"
  - id: F002
    severity: pass
    category: design
    summary: "Tool-use guidance is composed once, at the agent constructor"
    location: "src/squadron/tools/guidance.py:38"
  - id: F003
    severity: pass
    category: correctness
    summary: "SDK system prompt composes with instructions instead of discarding them"
    location: "src/squadron/providers/sdk/provider.py:58"
  - id: F004
    severity: pass
    category: correctness
    summary: "Degraded artifacts embed the raw response at default verbosity"
    location: "src/squadron/review/persistence.py:304"
  - id: F005
    severity: pass
    category: observability
    summary: "Tool-use telemetry is surfaced observably in review artifacts and logs"
    location: "src/squadron/review/review_client.py:268"
  - id: F006
    severity: pass
    category: testing
    summary: "Tests cover the new behavior and document the design rationale"
    location: "tests/providers/sdk/test_provider.py:105"
---
